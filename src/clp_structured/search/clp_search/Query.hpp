#ifndef CLP_STRUCTURED_SEARCH_CLP_SEARCH_QUERY_HPP
#define CLP_STRUCTURED_SEARCH_CLP_SEARCH_QUERY_HPP
...
#include "src/clp_structured/DictionaryEntry.hpp"
...
namespace clp_structured { namespace search { namespace clp_search {
    ...
    public:
        ...
        std::unordered_set<LogTypeDictionaryEntry const*> const& get_possible_logtype_entries(
        ) const {
...
#endif  // CLP_STRUCTURED_SEARCH_CLP_SEARCH_QUERY_HPP
