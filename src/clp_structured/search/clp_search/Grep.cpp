...
#include "src/clp_structured/VariableEncoder.hpp"
...
namespace clp_structured { namespace search { namespace clp_search {
    ...
    SubQueryMatchabilityResult generate_logtypes_and_vars_for_subquery(
        ...
        log_dict->get_entries_matching_wildcard_string(
                logtype,
                ignore_case,
    ...
    bool Grep::process_raw_query(
        ...
        processed_search_string
                = StringUtils::clean_up_wildcard_search_string(processed_search_string);
