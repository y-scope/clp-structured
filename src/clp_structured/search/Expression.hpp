#ifndef CLP_STRUCTURED_SEARCH_EXPRESSION_H
#define CLP_STRUCTURED_SEARCH_EXPRESSION_H
...
public:
    ...
    /**
     * The number of operands that this expression has
     * @return this expressions number of operands
     */
    ...
    /**
     * Return a reference to the underlying OpList. Useful
     * in cases where certain children need to be deleted, or
     * multiple children need to be spliced in.
     */
    ...
    /**
     * Gets the parent for this Expression
     * @return this Expression's parent. Can be nullptr if this is the top level.
     */
...
#endif  // CLP_STRUCTURED_SEARCH_EXPRESSION_H
