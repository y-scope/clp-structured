#ifndef CLP_STRUCTURED_TIMESTAMPDICTIONARYREADER_HPP
#define CLP_STRUCTURED_TIMESTAMPDICTIONARYREADER_HPP
...
#endif  // CLP_STRUCTURED_TIMESTAMPDICTIONARYREADER_HPP
