#ifndef CLP_STRUCTURED_TIMESTAMPDICTIONARYWRITER_HPP
#define CLP_STRUCTURED_TIMESTAMPDICTIONARYWRITER_HPP
...
#endif  // CLP_STRUCTURED_TIMESTAMPDICTIONARYWRITER_HPP
